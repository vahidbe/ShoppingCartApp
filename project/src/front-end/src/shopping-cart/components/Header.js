...
class Header extends Component{
    constructor(props){
        ...
        this.state = {
            showCart: false,
            mobileSearch: false,
            welcomeMsg: 'Welcome dear customer'
        };
    ...
    render(){
      ...
      cartItems = this.props.cartItems.map(product =>{
          ...
          <a className="product-remove" href="#" onClick={this.props.removeProduct.bind(this, product)}>×</a>
        </li>
			)
		});
    let view;
              ...
              <div className="container">
                <h1 className="welcome">
                    ...
                    this.props.authenticated ?
										`${this.state.welcomeMsg}: ${window.localStorage.getItem('username')} !` : `${this.state.welcomeMsg} !`
									}
								</h1>
								<button
                ...
                <div className="cart">
                  ...
                  <div ref="cartPreview" className={this.state.showCart ? "cart-preview active" : "cart-preview"} >
                    ...
                    <div className="action-block">
                      <button type="button" className={this.props.cartItems.length > 0 ? " " : "disabled"}
